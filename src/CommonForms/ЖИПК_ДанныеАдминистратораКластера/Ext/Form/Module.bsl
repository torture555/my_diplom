...
Процедура ПарсингКонстанты()
	...
	Если ЗначениеЗаполнено(НаборКонстант.ЖИПК_ДанныеАдминистратораКластера) Тогда
		ЛогинПароль = СтрРазделить(НаборКонстант.ЖИПК_ДанныеАдминистратораКластера, ";");
...
Процедура СформироватьКонстанту()
	...
	НаборКонстант.ЖИПК_ДанныеАдминистратораКластера = Логин + ";" + Пароль;
